...
cmake -S "%NATIVE_DIR%" -B "%ROOT_DIR%\build_win_64" -G "Visual Studio 17 2022" -A x64 ^
...
cmake -S "%NATIVE_DIR%" -B "%ROOT_DIR%\build_win_arm64" -G "Visual Studio 17 2022" -A ARM64 ^
    -DCMAKE_BUILD_TYPE:String=Distribution ^
    -DCROSS_PLATFORM_DETERMINISTIC=ON
if errorlevel 1 goto :error
...
copy /Y "%ROOT_DIR%\build_win_64\bin\Distribution\joltcd.dll" "%BIN_DIR%\win-x64\joltc.dll"
copy /Y "%ROOT_DIR%\build_win_64\bin\Debug\joltcd.dll" "%BIN_DIR%\win-x64\joltcd.dll"
copy /Y "%ROOT_DIR%\build_win_64\bin\Debug\joltcd.pdb" "%BIN_DIR%\win-x64\joltcd.pdb"

copy /Y "%ROOT_DIR%\build_win_arm64\bin\Distribution\joltcd.dll" "%BIN_DIR%\win-arm64\joltc.dll"
copy /Y "%ROOT_DIR%\build_win_arm64\bin\Debug\joltcd.dll" "%BIN_DIR%\win-arm64\joltcd.dll"
copy /Y "%ROOT_DIR%\build_win_arm64\bin\Debug\joltcd.pdb" "%BIN_DIR%\win-arm64\joltcd.pdb"
